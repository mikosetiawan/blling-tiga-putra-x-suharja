...
<div class="card max-w-2xl mx-auto">
    <div class="card-header">
        ...
        <div class="section-sub">Isi data di bawah ini untuk membuat akses pengguna baru.</div>
    </div>
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-4 mt-2">
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="roles[]" value="{{ $role->name }}" class="w-4 h-4 text-blue-600 bg-[#0f1117] border-[#2a3347] rounded focus:ring-blue-500 focus:ring-2" {{ in_array($role->name, old('roles', [])) ? 'checked' : '' }}>
