...
<body class="h-full flex">
    ...
    <aside class="sidebar fixed inset-y-0 left-0 flex flex-col z-50 overflow-y-auto">
        ...
        <nav class="flex-1 p-3">
            ...
            @if(auth()->user()->hasRole('admin') || auth()->user()->email === 'admin@3pp.co.id')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getBotResponse(input) {
                ...
                const responses = [
                    ...
                    { keywords: ["lupa", "password", "sandi", "ganti", "wifi"], text: "Demi keamanan, jika Anda butuh mengganti nama WiFi atau Password, infokan kepada sistem admin (via WhatsApp CS / teknisi) dan sertakan ID Pelanggan. Perubahan dari jarak jauh akan kami pandu." },
